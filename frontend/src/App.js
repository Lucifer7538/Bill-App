...
export default function App() {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      const matchedSc = (settings.shortcuts || []).find(sc => sc.key && e.key.toLowerCase() === sc.key.toLowerCase() && !!sc.ctrl === (e.ctrlKey || e.metaKey) && !!sc.shift === e.shiftKey);
      if (matchedSc) {
        e.preventDefault();
        ...
        <aside className="controls no-print dual-pane-right">
          ...
          <div className="control-card">
            ...
            {(txType === "booking" || txType === "service") && (
              <div style={{ backgroundColor: '#f8fafc', padding: '15px', borderRadius: '8px', border: '1px solid #cbd5e1' }}>
                <h4 style={{ margin: '0 0 10px 0', color: '#16a34a' }}>Advance Payment</h4><Input placeholder="Advance Received ₹" value={advanceAmount} onChange={e => {setAdvanceAmount(e.target.value); markDirty();}} style={{ marginBottom: '10px' }} />
