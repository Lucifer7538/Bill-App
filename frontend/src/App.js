...
export default function App() {
  ...
  const shareWhatsApp = () => { const link = `${window.location.origin}/?view=${documentNumber}`; const text = `Hello\n dera, ${customer.name || "Customer"},Sir/Ma'am\n\nThis Is an Official ${mode === "invoice" ? "Invoice" : "Estimate"} Bill From Jalaram Jewellers: The Silver Specialist\n\n Here Is Your Bill No. ${documentNumber}\n Amount: ₹${money(computed.grandTotal)}.\n\n Here You can view and download it securely\n Link: ${link}\n\n         *Contact and promotion*     \n\n Here Is Our Official WhatsApp Group\n link: https://chat.whatsapp.com/FHoih8XtTXGLtPvHWx7MO6?mode=gi_t\n Here Is Our Instagram\n Link: https://www.instagram.com/jalaram_jewellers_?igsh=MWZnNmlzMTYyOWNzeA%3D%3D&utm_source=qr\n\n             *Feedback Us*\n\n Sir/Madam, If You Don't Mind, Please Give us a minute to Rate our Behaviour and Service. Give us your Valuable Feedback so we can make your experience even better:\n ${activeBillBranch.map_url}\n\n   Thank you,\n${settings.shop_name} : The Silver Specialist\n\n  `; let cleanedPhone = customer.phone.replace(/\D/g, ""); if (cleanedPhone.length === 10) cleanedPhone = `91${cleanedPhone}`; window.open(`https://wa.me/${cleanedPhone}?text=${encodeURIComponent(text)}`, "_blank"); };
