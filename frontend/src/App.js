      ...
      <div className="billing-app" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
        ...
        <section id="public-bill-root" className="bill-sheet" style={{ "--print-scale-factor": 1, position: 'relative', zIndex: 1 }}>
          ...
          <table className="bill-table" style={{ width: "100%", tableLayout: "fixed", wordWrap: "break-word" }}>
            ...
            <tbody>
              {publicComputed.items.map((item, idx) => (
                <tr key={idx}>
                  {publicBill.mode === "invoice" ? (
                    <><td>{item.sl_no}</td><td>{item.description || "-"}</td><td>{item.hsn || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.rate)}</td><td style={{ whiteSpace: "nowrap" }}>{item.rupees}.{item.paise}</td></>
                  ) : (
                    <><td>{item.sl_no}</td><td>{item.description || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.quantity)} x {money(item.rate)}</td><td style={{ whiteSpace: "nowrap" }}>{item.rupees}</td><td style={{ whiteSpace: "nowrap" }}>{item.paise}</td></>
                  )}
                </tr>
              ))}
            </tbody>
                ...
                <table className="bill-table" style={{ width: "100%", tableLayout: "fixed", wordWrap: "break-word" }}>
                  ...
                  <tbody>
                    {(b.items || []).map((item, idx) => {
                      const amount = (item.amount !== undefined && item.amount !== null && item.amount !== "") ? num(item.amount) : num(item.amount_override || 0);
                      const { rupees, paise } = splitAmount(amount);
                      const rate = (item.rate !== undefined && item.rate !== null) ? num(item.rate) : num(item.rate_override || 0);
                      
                      return b.mode === "invoice" ? (
                        <tr key={idx}><td>{item.sl_no || (idx + 1)}</td><td>{item.description || "-"}</td><td>{item.hsn || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(rate)}</td><td style={{ whiteSpace: "nowrap" }}>{rupees}.{paise}</td></tr>
                      ) : (
                        <tr key={idx}><td>{item.sl_no || (idx + 1)}</td><td>{item.description || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.quantity || 1)} x {money(rate)}</td><td style={{ whiteSpace: "nowrap" }}>{rupees}</td><td style={{ whiteSpace: "nowrap" }}>{paise}</td></tr>
                      );
                    })}
                  </tbody>
                </table>
          ...
          <table className="bill-table" style={{ width: "100%", tableLayout: "fixed", wordWrap: "break-word" }}>
            ...
            <tbody>
              {computed.items.map((item, idx) => (
                <tr key={item.id}>
                  {mode === "invoice" ? (
                    <><td>{item.slNo}</td><td>{item.description || "-"}</td><td>{item.hsn || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.rate)}</td><td style={{ whiteSpace: "nowrap" }}>{item.rupees}.{item.paise}</td></>
                  ) : (
                    <><td>{item.slNo}</td><td>{item.description || "-"}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.weight)}</td><td style={{ whiteSpace: "nowrap" }}>{money(item.quantity)} x {money(item.rate)}</td><td style={{ whiteSpace: "nowrap" }}>{item.rupees}</td><td style={{ whiteSpace: "nowrap" }}>{item.paise}</td></>
                  )}
                </tr>
              ))}
            </tbody>
              ...
              <div className="settings-design-tab" style={{ width: "100%" }}>
                ...
                <div style={{ padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", marginBottom: "15px", backgroundColor: "#f8fafc", width: "100%", boxSizing: "border-box" }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", width: "100%" }}>
                    <input type="color" value={settings.shop_name_color || "#000000"} onChange={(e) => setSettings((prev) => ({ ...prev, shop_name_color: e.target.value }))} style={{ width: "40px", height: "35px", cursor: "pointer", padding: "0", border: "1px solid #ccc", borderRadius: "4px", flexShrink: 0 }} />
                    <Input type="number" min="8" max="60" value={settings.shop_name_size || 26} onChange={(e) => setSettings((prev) => ({ ...prev, shop_name_size: Number(e.target.value) }))} style={{ width: "70px", padding: "0 5px", textAlign: "center", flexShrink: 0 }} />
                    <select value={settings.shop_name_font || "sans-serif"} onChange={(e) => setSettings((prev) => ({ ...prev, shop_name_font: e.target.value }))} style={{ flex: "1 1 120px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "120px" }}>
                      <FontSelectOptions customFonts={settings.custom_fonts || []} />
                    </select>
                    <select value={settings.shop_name_align || "center"} onChange={(e) => setSettings((prev) => ({ ...prev, shop_name_align: e.target.value }))} style={{ flex: "1 1 80px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "80px" }}>
                ...
                <div style={{ padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", marginBottom: "15px", backgroundColor: "#f8fafc", width: "100%", boxSizing: "border-box" }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", width: "100%" }}>
                    <input type="color" value={settings.tagline_color || "#475569"} onChange={(e) => setSettings((prev) => ({ ...prev, tagline_color: e.target.value }))} style={{ width: "40px", height: "35px", cursor: "pointer", padding: "0", border: "1px solid #ccc", borderRadius: "4px", flexShrink: 0 }} />
                    <Input type="number" min="8" max="60" value={settings.tagline_size || 12} onChange={(e) => setSettings((prev) => ({ ...prev, tagline_size: Number(e.target.value) }))} style={{ width: "70px", padding: "0 5px", textAlign: "center", flexShrink: 0 }} />
                    <select value={settings.tagline_font || "sans-serif"} onChange={(e) => setSettings((prev) => ({ ...prev, tagline_font: e.target.value }))} style={{ flex: "1 1 120px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "120px" }}>
                      <FontSelectOptions customFonts={settings.custom_fonts || []} />
                    </select>
                    <select value={settings.tagline_align || "center"} onChange={(e) => setSettings((prev) => ({ ...prev, tagline_align: e.target.value }))} style={{ flex: "1 1 80px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "80px" }}>
                      <option value="left">Left</option><option value="center">Center</option><option value="right">Right</option>
                    </select>
                  </div>
                </div>
                ...
                <div style={{ padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", marginBottom: "15px", backgroundColor: "#f8fafc", width: "100%", boxSizing: "border-box" }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", width: "100%" }}>
                    <input type="color" value={settings.address_color || "#475569"} onChange={(e) => setSettings((prev) => ({ ...prev, address_color: e.target.value }))} style={{ width: "40px", height: "35px", cursor: "pointer", padding: "0", border: "1px solid #ccc", borderRadius: "4px", flexShrink: 0 }} />
                    <Input type="number" min="8" max="60" value={settings.address_size || 14} onChange={(e) => setSettings((prev) => ({ ...prev, address_size: Number(e.target.value) }))} style={{ width: "70px", padding: "0 5px", textAlign: "center", flexShrink: 0 }} />
                    <select value={settings.address_font || "sans-serif"} onChange={(e) => setSettings((prev) => ({ ...prev, address_font: e.target.value }))} style={{ flex: "1 1 120px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "120px" }}>
                      <FontSelectOptions customFonts={settings.custom_fonts || []} />
                    </select>
                    <select value={settings.address_align || "center"} onChange={(e) => setSettings((prev) => ({ ...prev, address_align: e.target.value }))} style={{ flex: "1 1 80px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "80px" }}>
                      <option value="left">Left</option><option value="center">Center</option><option value="right">Right</option>
                    </select>
                  </div>
                </div>
                ...
                <div style={{ padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", marginBottom: "15px", backgroundColor: "#f8fafc", width: "100%", boxSizing: "border-box" }}>
                  ...
                  <Input value={(settings.phone_numbers || []).join(", ")} onChange={(e) => setSettings((prev) => ({ ...prev, phone_numbers: e.target.value.split(",").map(i=>i.trim()).filter(Boolean) }))} placeholder="Phone numbers (comma separated)" style={{ marginBottom: "10px", width: "100%", boxSizing: "border-box" }} />
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", width: "100%" }}>
                    <input type="color" value={settings.phone_color || "#475569"} onChange={(e) => setSettings((prev) => ({ ...prev, phone_color: e.target.value }))} style={{ width: "40px", height: "35px", cursor: "pointer", padding: "0", border: "1px solid #ccc", borderRadius: "4px", flexShrink: 0 }} />
                    <Input type="number" min="8" max="60" value={settings.phone_size || 13} onChange={(e) => setSettings((prev) => ({ ...prev, phone_size: Number(e.target.value) }))} style={{ width: "70px", padding: "0 5px", textAlign: "center", flexShrink: 0 }} />
                    <select value={settings.phone_font || "sans-serif"} onChange={(e) => setSettings((prev) => ({ ...prev, phone_font: e.target.value }))} style={{ flex: "1 1 120px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "120px" }}>
                      <FontSelectOptions customFonts={settings.custom_fonts || []} />
                    </select>
                    <select value={settings.phone_align || "center"} onChange={(e) => setSettings((prev) => ({ ...prev, phone_align: e.target.value }))} style={{ flex: "1 1 80px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "80px" }}>
                      <option value="left">Left</option><option value="center">Center</option><option value="right">Right</option>
                    </select>
                  </div>
                </div>
                ...
                <div style={{ padding: "12px", border: "1px solid #e2e8f0", borderRadius: "8px", marginBottom: "15px", backgroundColor: "#f8fafc", width: "100%", boxSizing: "border-box" }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center", width: "100%" }}>
                    <input type="color" value={settings.email_color || "#475569"} onChange={(e) => setSettings((prev) => ({ ...prev, email_color: e.target.value }))} style={{ width: "40px", height: "35px", cursor: "pointer", padding: "0", border: "1px solid #ccc", borderRadius: "4px", flexShrink: 0 }} />
                    <Input type="number" min="8" max="60" value={settings.email_size || 13} onChange={(e) => setSettings((prev) => ({ ...prev, email_size: Number(e.target.value) }))} style={{ width: "70px", padding: "0 5px", textAlign: "center", flexShrink: 0 }} />
                    <select value={settings.email_font || "sans-serif"} onChange={(e) => setSettings((prev) => ({ ...prev, email_font: e.target.value }))} style={{ flex: "1 1 120px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "120px" }}>
                      <FontSelectOptions customFonts={settings.custom_fonts || []} />
                    </select>
                    <select value={settings.email_align || "center"} onChange={(e) => setSettings((prev) => ({ ...prev, email_align: e.target.value }))} style={{ flex: "1 1 80px", height: "35px", border: "1px solid #ccc", borderRadius: "6px", fontSize: "0.85rem", padding: "0 5px", minWidth: "80px" }}>
                      <option value="left">Left</option><option value="center">Center</option><option value="right">Right</option>
                    </select>
                  </div>
                </div>
